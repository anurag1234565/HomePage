...
<html>
  ...
  <body >
    <a href="https://github.com/anurag1234565/HomePage"><img src="images/fork.png" align="right"></a>
    <div class="w3-padding-128">
      ...
      <div class="w3-sand w3-opacity w3-card wide w3-round-xlarge" style="margin:auto;min-height:20em;"><!-- Tabs -->
          ...
          <div class="w3-col tabholder "><!-- col1 --> 
              <button class="fa fa-facebook w3-hover-indigo w3-hover-shadow w3-round-large tabs w3-xxxlarge" onclick="window.location = 'http://facebook.com'"><!--facebook --></button>
              <div class="w3-center"><b>Facebook</b></div>
              
              <button class="fa fa-twitter w3-hover-blue w3-hover-shadow w3-round-large tabs w3-xxxlarge" onclick="window.location = 'http://twitter.com'"><!-- twitter--></button>
              <div class="w3-center"><b>Twitter</b></div>
              
          </div>
          
          <div class="w3-col tabholder "><!-- col2 --> 
              <button class="fa fa-github w3-hover-black w3-hover-shadow w3-round-large tabs w3-xxxlarge" onclick="window.location = 'http://github.com'"><!--facebook --></button>
              <div class="w3-center"><b>GitHub</b></div>
              
              <button class="fa fa-youtube w3-hover-red w3-hover-shadow w3-round-large tabs w3-xxxlarge" onclick="window.location = 'http://youtube.com'"><!-- twitter--></button>
              <div class="w3-center"><b>YouTube</b></div>
              
          </div>
          
          <div class="w3-col tabholder "><!-- col3 --> 
              <button class="fa fa-soundcloud w3-hover-deep-orange w3-hover-shadow w3-round-large tabs w3-xxxlarge" onclick="window.location = 'http://soundcloud.com'"><!--SoundCloud --></button>
              <div class="w3-center"><b>SoundCloud</b></div>
              
              <button class="fa fa-google w3-hover-red w3-round-large tabs w3-hover-shadow w3-xxxlarge" onclick="window.location = 'http://mail.google.com'"><!-- g-mail--></button>
              <div class="w3-center"><b>G-mail</b></div>
              
          </div>
          
          <div class="w3-col tabholder "><!-- col4 --> 
              <button class="fa fa-stack-overflow w3-hover-orange w3-round-large w3-hover-shadow tabs w3-xxxlarge" onclick="window.location = 'http://stackoverflow.com'"><!--StackOverflow --></button>
              <div class="w3-center"><b>Stack-Overflow</b></div>
              
              <button class="fa fa-instagram w3-hover-pale-green w3-round-large w3-hover-shadow tabs w3-xxxlarge" onclick="window.location = 'http://instagram.com'"><!-- instagram--></button>
